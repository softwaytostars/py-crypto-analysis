...
class TestUtils(TestCase):
    ...
    def test_sort_by_profit(self):
        ...
        dictEvalSell = {'ETCBTC': Evaluation(0.65, 0.15),
                        ...
                        'BNBBTC': Evaluation(0.7, 0.15)}
        wallet = Wallet()
        wallet.add_to_wallet_with_origin('ETC', 'ETCBTC', 0.05, 1)  # profit 0.1
        wallet.add_to_wallet_with_origin('BTC', 'BTCEUR', 0.15, 1)  # profit 0
        wallet.add_to_wallet_with_origin('ETH', 'ETHEUR', 0.01, 1)  # profit 0.14
        wallet.add_to_wallet_with_origin('BNB', 'BNBBTC', 0.04, 1)  # profit 0.11
